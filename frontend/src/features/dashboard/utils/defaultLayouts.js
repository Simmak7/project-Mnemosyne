...
export const DEFAULT_LAYOUTS = {
  ...
  xs: [
    ...
    { i: 'calendar',       x: 0, y: 6,  w: 2, h: 5, minW: 2, minH: 2 },
    { i: 'favorites',      x: 0, y: 11, w: 2, h: 5, minW: 2, minH: 2 },
    { i: 'tasks',          x: 0, y: 16, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'quick-upload',   x: 0, y: 19, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'knowledge-graph',x: 0, y: 22, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'system-status',  x: 0, y: 25, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'recent-notes',   x: 0, y: 28, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'top-tags',       x: 0, y: 31, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'most-connected', x: 0, y: 34, w: 2, h: 3, minW: 2, minH: 2 },
    { i: 'ai-activity',    x: 0, y: 37, w: 2, h: 3, minW: 2, minH: 2 },
  ],
};
